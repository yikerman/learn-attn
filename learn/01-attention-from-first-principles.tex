...
This gives you a Python environment with PyTorch (and the documents assume a CUDA device present). All demo code in Documents 01--03 can be run in a Python REPL (\code{uv run python}). Starting in Document 04, we will create the actual project source files.
