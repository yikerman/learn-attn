...
This class will go into \code{babygpt/model.py} in Chapter~4. For now, understand the structure.
...
Preview of the forward pass in \code{BabyGPT}, which we build in Chapter~4.
...
We now have the complete building block. In Chapter~3, we look at the full encoder-decoder architecture from the original paper. In Chapter~4, we simplify to the decoder-only GPT architecture we implement.
