...
\newcommand{\demotag}{%
  \par\noindent
  \colorbox{NavyBlue!12}{\small\sffamily\bfseries Demo \textnormal{--- try in a REPL, not part of the project}}%
  \nopagebreak\par\nopagebreak\vspace{-0.6em}%
}
...
\newcommand{\concepttag}{%
  \par\noindent
  \colorbox{black!6}{\small\sffamily\bfseries Conceptual \textnormal{--- illustrating the idea, not runnable as-is}}%
  \nopagebreak\par\nopagebreak\vspace{-0.6em}%
}
