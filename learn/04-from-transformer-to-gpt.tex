...
The attention sublayer has one combined QKV projection and one output projection:
\begin{itemize}
  \item \code{c\_attn} (QKV combined): $384 \times (3 \times 384) = 384 \times 1152 = 442{,}368$
...
#   - CausalSelfAttention (Document 01, Section 6-7)
