...
BPE is covered in detail in Document 05, Section 1. Sharing means the model uses one set of embedding vectors for, say, the token ``the'' regardless of whether it appears on the source side or the target side.
