...
Create \code{src/generate.py} --- a CLI wrapper that loads a checkpoint, encodes the prompt, calls \code{model.generate()}, and prints the result. The full implementation is in the project repository.
